...
class TerminalUI:
    ...
    def run(self):
        ...
        while True:
            ...
            if opt == "m":
                ...
                log.error(f"menu case '{opt}' is missing, aborting")
                return 1
    ...
    def display_tree(self):
        ...
        self.show_2d()
        print("")
        print(f"Size:      {self._tree.size()}")
        print(f"Height:    {self._tree.height()}")
        print(f"Inorder:   {self._tree.inorder()}")
        print(f"Preorder:  {self._tree.preorder()}")
        print(f"Postorder: {self._tree.postorder()}")
